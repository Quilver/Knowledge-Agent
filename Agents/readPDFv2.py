...
def pdf_to_md(pdf_path:str, output_dir:Path):
...
if __name__ == "__main__":
    input_doc_path = "C:/Users/Quinte/OneDrive/Desktop/Lichemaster campaign/Vengeance.pdf"
    output_dir = Path("E:/lichemaster vengence")
